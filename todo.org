...
* DONE Provide a way to mark a task as complete
c 1 2 3
Marks tasks 1, 2, and 3 as complete
Add a "Marking as complete - are you sure" prompt
* DONE Create a list
* DONE Command to move a task to another list
Make it a multi-part command?
move 1 3 5 (move 3 tasks)
(display all lists)
Move 1 to which list: 
* TODO Make to do list self hosting in RTM
* TODO Command to postpone a task
* TODO Command to rename a task
* TODO Delete a list
